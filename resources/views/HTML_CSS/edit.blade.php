...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; 编辑HTML_CSS问答对
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/HTML_CSS/create')}}"><i class="fa fa-plus"></i>添加HTML_CSS问答对</a>
    ...
    <div class="result_wrap">
        <form action="{{url('admin/HTML_CSS/'.$field->id)}}" method="post">
